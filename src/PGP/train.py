...
if not os.path.isdir(os.path.join(args.output_dir, 'wandb_logs')):
    os.mkdir(os.path.join(args.output_dir, 'wandb_logs'))
...
# Train
trainer = Trainer(cfg, args.data_root, args.data_dir, checkpoint_path=args.checkpoint)
